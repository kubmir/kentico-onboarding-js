...
describe('Reducer isAddingNote tests', () => {
  ...
  it('should set isAddListMemberFocused to true when START_ADDING_NOTE_FOCUS is dispatched', () => {
  ...
  it('should set isAddListMemberFocused to false when STOP_ADDING_NOTE_FOCUS is dispatched', () => {
